...
SEEDED_SCENARIOS: Dict[str, Dict] = {
    ...
    "TXN_BORDERLINE_REVIEW_001": {
        "id": "TXN_BORDERLINE_REVIEW_001",
        "amount": 12400.0,
        "payment_method": "UPI",
        "merchant_category": "Fashion & Apparel",
        "customer_age_days": 45,
        "device_age_days": 8,
        "prior_success_count": 7,
        "prior_chargeback_count": 0,
        "velocity_1h": 2,
        "velocity_24h": 5,
        "pincode_distance_km": 28.5,
        "phone_verified": 1,
        "device_trusted": 0,
        "ip_country_match": 1,
        "hour": 14,
        "timestamp_display": "02:22 PM",
        "label": "Borderline Review — ₹12.4k UPI",
        "description": "Mid-tenure customer on a week-old device with moderate transaction history. The decision sits on a knife-edge — small changes to any single parameter can flip it between REVIEW and APPROVE.",
        "badge_type": "borderline",
        "expected_outcome": "REVIEW (~55-65 score, highly sensitive to device maturation)",
        "short_summary": "Edge case demonstrating sensitivity: device maturation alone can transition from REVIEW to APPROVE.",
    },
}
